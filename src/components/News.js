...
const News = (props) => {
    ...
    const handlePrevClick = async () => {
        // code of class based component of previous clikc button


        // let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=793cdb8010144ff9a49710545e8388e0&page=${this.state.page - 1}&pageSize=${props.pageSize}`;
    ...
    return (
        <>
            <h2 className='text-center' style={{ marginTop: '90px' }}>NewsApp - Top {props.category} Headlines</h2>
            {loading && <Spinner />}
            <InfiniteScroll
            ...
            {/* <div className='container d-flex justify-content-between'>
                    <button disabled={this.state.page <= 1} type="button" className="btn btn-secondary" onClick={this.handlePrevClick}> &larr; Pervious</button>
